...
urlpatterns = [
               ...
               # товар в корзине ++
               url(r'cart_add_product/(?P<product_id>\d+)$', increase_product_quantity_in_cart, name='add'),
               # товар  в корзине --
               url(r'cart_rem_product/(?P<product_id>\d+)$', decrease_product_quantity_in_cart, name='rem'),
               # оформить заказ
