# -*- coding: utf-8 -*-
# Generated by Django 1.9.1 on 2016-01-06 18:11
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order_code', models.CharField(default=746, max_length=4, verbose_name='Код заказа')),
                ('order_sum', models.IntegerField(default=0, max_length=5, verbose_name='Сумма заказа')),
            ],
            options={
                'verbose_name': 'Заказ',
                'db_table': 'order',
